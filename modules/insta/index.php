...
<div class="hidden lg:flex items-center justify-center w-[420px]">
...
<span class="px-4 text-xs font-semibold text-[#8e8e8e]">
...
<button
class="flex items-center justify-center gap-2 text-[#385185] font-semibold text-sm">
...
<a href="#"
class="text-xs text-[#e0f1ff] mt-4">
...
<footer
class="p-8 text-[#8e8e8e] text-xs text-center flex flex-wrap justify-center gap-4">
